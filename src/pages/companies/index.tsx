...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'annual_revenue', header: 'Annual Revenue', accessorKey: 'annual_revenue' },
    { id: 'company_location', header: 'Company Location', accessorKey: 'company_location' },
