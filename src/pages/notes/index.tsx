...
import { useRoqClient, useNoteFindManyWithCount } from 'lib/roq';
...
export function NoteListPage(props: NoteListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useNoteFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.note.delete({ where: { id } });
      await mutate();
    } catch (error) {
