...
import { useStageFindFirst, useRoqClient } from 'lib/roq';
...
function StageViewPage() {
  ...
  const { data, error, isLoading } = useStageFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('stage', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/stages/edit/${id}`} passHref legacyBehavior>
                    <Button
