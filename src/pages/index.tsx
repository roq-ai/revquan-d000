  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="RevQuan: Empowering your business with a CRM-like platform, streamlining customer interactions and maximizing revenue potential."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1585974738771-84483dd9f89f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxDUk18ZW58MHx8fHwxNjk4ODIyNjk3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`RevQuan: Empowering your business with a CRM-like platform, streamlining customer interactions and maximizing revenue potential.`}
            </Text>
            <Box
