...
import { usePipelineFindFirst, useRoqClient } from 'lib/roq';
...
function PipelineViewPage() {
  ...
  const { data, error, isLoading } = usePipelineFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('pipeline', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/pipelines/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={data?.expected_close_date ? format(data?.expected_close_date, 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Progress Status" text={data?.progress_status} />
