...
import { useRoqClient, useContactFindManyWithCount } from 'lib/roq';
...
export function ContactListPage(props: ContactListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useContactFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.contact.delete({ where: { id } });
      await mutate();
    } catch (error) {
