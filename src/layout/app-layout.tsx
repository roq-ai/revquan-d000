...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'owner', 'sales-manager', 'sales-representative', 'marketing-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Contacts', path: '/contacts', entity: 'contact', service: AccessServiceEnum.PROJECT, icon: FiUser },
    { name: 'Deals', path: '/deals', entity: 'deal', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    ...
    { name: 'Products', path: '/products', entity: 'product', service: AccessServiceEnum.PROJECT, icon: FiPackage },
    { name: 'Services', path: '/services', entity: 'service', service: AccessServiceEnum.PROJECT, icon: FiServer },
    { name: 'Stages', path: '/stages', entity: 'stage', service: AccessServiceEnum.PROJECT, icon: FiTrello },
